...
public class LuceneReadIndex {
  ...
  private static TopDocs searchByFirstName(String firstName, IndexSearcher searcher)
    throws Exception {
    QueryParser qp = new QueryParser("firstName", new StandardAnalyzer());
    Query nameQuery = qp.parse(firstName);
  ...
  public static void main(String[] args)
    ...
    // Search by firstName
    TopDocs foundDocs2 = searchByFirstName("Suhajit", searcher);
